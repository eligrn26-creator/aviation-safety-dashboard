...
- **Mechanical failures** show spikes in certain years—potential maintenance trends.
...
knitr::kable(sms_summary, caption = "Summary of SMS-Relevant Accidents by Domain")#### 🧩 Shiny Dashboard Scaffold (for later)
```

#### 🧩 Shiny Dashboard Scaffold (for later)
